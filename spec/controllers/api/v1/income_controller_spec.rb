...
describe Api::V1::IncomeController do
  describe 'GET #index' do
    before(:each) do
      ...
      create(:access_scope, role_id: @director.id, field_access: %w[base_salary overtime_payment])

      @manager_keys_filter = %w[base_salary employee_name id]
      @director_keys_filter = %w[base_salary employee_name id overtime_payment]
    end
